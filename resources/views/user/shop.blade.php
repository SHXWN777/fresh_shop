                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="{{ asset('home/images/img-pro-01.jpg')}} class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                    ...
                    <div class="filter-sidebar-left">
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            ...
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="{{ route('category', [$category->id, $category->slug]) }}" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{ $category->category_name }} <small class="text-muted">({{ $category->product_count }})</small>
                            </a>
                                ...
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    ...
                                    <div class="list-group">
                                        ...
                                        <a href="{{ route('category', [$subcategory->id, $subcategory->slug]) }}" class="list-group-item list-group-item-action active">{{ $subcategory->subcategory_name }} <small class="text-muted">({{ $subcategory->product_count }})</small></a>
                                        @endforeach
